...
public:
	Weapon(std::string _name, bool pickup, std::string desc, std::string itemType, int dur, bool ultimate);//Initializes weapon with name, whether it can be picked up, its description, its durability, and if it is the ultimate weapon
	~Weapon();//Destructor
...
public:
	ActionObject(std::string _name, bool pickup, std::string desc, std::string itemType, std::string _effect);//Initializes an action object with name, whether it can be picked up, its description, and its effect
